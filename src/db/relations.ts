...
import { data, habits, activity, progress, challenges, users, achievements, routines, groups, profile, objective, groupmembers, publications, comentarios, objectivekeywords, keywords, activitykeywords, habitskeywords, grouptags, tags, tagkeywords, publicationtags, have } from "./schema";
