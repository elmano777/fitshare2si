...
export const keywords = pgTable(
  ...
  (table) => [unique('keywords_keyword_key').on(table.keyword)],
);
...
export const tags = pgTable(
  ...
  (table) => [unique('tags_tag_name_key').on(table.tagName)],
);
...
export const objectivekeywords = pgTable(
  'objectivekeywords',
  {
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.objectiveId, table.keywordId],
...
export const activitykeywords = pgTable(
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.activityId, table.keywordId],
      name: 'activitykeywords_pkey',
    }),
  ],
);

export const habitskeywords = pgTable(
  'habitskeywords',
  {
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.habitId, table.keywordId],
...
export const tagkeywords = pgTable(
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.tagId, table.keywordId],
...
export const publicationtags = pgTable(
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.publicationId, table.tagId],
      name: 'publicationtags_pkey',
    }),
  ],
);

export const have = pgTable(
  'have',
  {
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.idprogress, table.idusers],
      name: 'have_pkey',
    }),
  ],
);
